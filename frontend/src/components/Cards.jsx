...
const Cards = ({ item }) => {
  ...
  // Truncate the description after 100 characters (or any other limit you choose)
  ...
  return (
    <div to={`/menu/${item._id}`} className="card shadow-xl relative mr-5 md:my-5">
      ...
      <Link to={`/products/${_id}`}> {/* Correct way to link to a specific product */}
        <figure>
          <img src={image} alt="#" className="hover:scale-105 transition-all duration-300 md:h-72" />
        </figure>
      </Link>
